...
# I use Docker for containerising services and running local dev environments.
# The 'd' prefix is consistent across all container commands.
# =============================================================================
...
# Docker Compose - I use these for spinning up multi-container local environments
