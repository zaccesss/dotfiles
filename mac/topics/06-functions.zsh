...
_cmds_body() {
    ...
    echo "  ${CYAN}flushdns${RESET}        ${WHITE}clear the DNS resolver cache${RESET}"
    ...
    echo "  ${CYAN}kn${RESET}                              ${WHITE}switch the default namespace${RESET}"
    echo "  ${CYAN}kgpw${RESET}                            ${WHITE}watch pods live${RESET}"
    echo ""
