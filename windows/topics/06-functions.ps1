...
function _cmdsBody {
    ...
    "  `e[36mflushdns`e[0m`e[37m      clear the DNS resolver cache`e[0m"
    ...
    "  `e[36mdip`e[0m`e[37m                            print a container's IP address`e[0m"
    ""

    "`e[35mKUBERNETES`e[0m"
    "  `e[36mkc / kg / ka / kd / klogs / kns / kctx / kpods`e[0m"
    "  `e[36mkn`e[0m`e[37m                              switch the default namespace`e[0m"
    "  `e[36mkgpw`e[0m`e[37m                            watch pods live`e[0m"
    ""
